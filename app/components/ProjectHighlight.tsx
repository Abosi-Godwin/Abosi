    ...
    <div className="py-10 px-5 grid grid-cols-1 gap-8 md:grid-cols-2">
      <div className="">
        ...
        <p className="tracking-wide">
          A personal finance app that helps users track expenses, manage income,
      ...
      <div className="row-span-2">
        ...
        >
          {introInfo.map((data, index) => (
            <SwiperSlide key={index} className="w-[95%]">
      ...
      <ul className="divide-y-2 divide-gray-100 gap-2 flex flex-col py-6">
        {projectHighlight.map((data, index) => (
          <li key={index} className="flex gap-2 justify-start items-centfer">
